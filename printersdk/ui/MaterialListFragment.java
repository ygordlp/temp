...
public final class MaterialListFragment extends Fragment {
    ...
    public final void initView(View view) {
        ...
        new KBaseAdapter.Builder(recyclerView2).setData(this.datas).setLayoutId(R.layout.item_material_picker).addBindView(new MaterialListFragment$initView$1(this)).build();
    }
}
