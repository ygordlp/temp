...
final class FloatMenuDialog$initView$1 extends Lambda implements Function3<View, String, Integer, Unit> {
    final /* synthetic */ FloatMenuDialog this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FloatMenuDialog$initView$1(FloatMenuDialog floatMenuDialog) {
        super(3);
        this.this$0 = floatMenuDialog;
    }
    ...
    public final void invoke(View view, final String str, int i) {
        ...
        if (floatMenuItemBinding != null) {
            ...
            if (Intrinsics.areEqual((Object) this.this$0.getSelectText(), (Object) str)) {
                floatMenuItemBinding.statusSelect.setVisibility(0);
            } else {
                floatMenuItemBinding.statusSelect.setVisibility(4);
            }
            final FloatMenuDialog floatMenuDialog = this.this$0;
            BaseExtendsKt.click(view, (Function1<? super View, Unit>) new Function1<View, Unit>() {
                ...
                public final void invoke(View view) {
                    ...
                    floatMenuDialog.setSelectText(str);
                    Function1<String, Unit> callback = floatMenuDialog.getCallback();
                    if (callback != null) {
                        callback.invoke(floatMenuDialog.getSelectText());
                    }
