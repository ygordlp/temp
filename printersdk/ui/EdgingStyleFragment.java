...
public final class EdgingStyleFragment extends Fragment {
    ...
    public final void initView(View view) {
        ...
        if (fragmentMaterialStyleBinding != null) {
            ...
            if (!(printEditViewModel == null || (drawingSurfaceView = printEditViewModel.drawingSurfaceView) == null || (graphManger = drawingSurfaceView.getGraphManger()) == null || (curSelectGraph = graphManger.getCurSelectGraph()) == null)) {
                ...
                fragmentMaterialStyleBinding.reverseSwitch.setChecked(edgingStyle.isReverse());
                fragmentMaterialStyleBinding.colorBlack.setChecked(!edgingStyle.isRedTintColor());
                fragmentMaterialStyleBinding.colorRed.setChecked(edgingStyle.isRedTintColor());
            }
            fragmentMaterialStyleBinding.scaleSwitch.setOnCheckedChangeListener(new EdgingStyleFragment$$ExternalSyntheticLambda0(this));
            fragmentMaterialStyleBinding.reverseSwitch.setOnCheckedChangeListener(new EdgingStyleFragment$$ExternalSyntheticLambda1(this));
            fragmentMaterialStyleBinding.colorRed.setOnClickListener(new EdgingStyleFragment$$ExternalSyntheticLambda2(this));
            fragmentMaterialStyleBinding.colorBlack.setOnClickListener(new EdgingStyleFragment$$ExternalSyntheticLambda3(this));
        }
    }
    ...
    public static final void initView$lambda$2(EdgingStyleFragment edgingStyleFragment, CompoundButton compoundButton, boolean z) {
        GraphManger graphManger;
        Intrinsics.checkNotNullParameter(edgingStyleFragment, "this$0");
    ...
    /* access modifiers changed from: private */
    public static final void initView$lambda$4(EdgingStyleFragment edgingStyleFragment, View view) {
        Intrinsics.checkNotNullParameter(edgingStyleFragment, "this$0");
        edgingStyleFragment.onCheckColor(true);
    }

    /* access modifiers changed from: private */
    public static final void initView$lambda$5(EdgingStyleFragment edgingStyleFragment, View view) {
        Intrinsics.checkNotNullParameter(edgingStyleFragment, "this$0");
        edgingStyleFragment.onCheckColor(false);
    }
    ...
    private final void onCheckColor(boolean z) {
        ...
        PrintEditViewModel printEditViewModel = this.viewModel;
        if (!(printEditViewModel == null || (graphManger = printEditViewModel.getGraphManger()) == null)) {
            graphManger.updateEdgingRedTintColor(z);
        }
