...
public final class FragmentMaterialListBinding implements ViewBinding {
    ...
    private FragmentMaterialListBinding(LinearLayout linearLayout, RecyclerView recyclerView2) {
    ...
    public static FragmentMaterialListBinding bind(View view) {
        ...
        if (recyclerView2 != null) {
            return new FragmentMaterialListBinding((LinearLayout) view, recyclerView2);
        }
